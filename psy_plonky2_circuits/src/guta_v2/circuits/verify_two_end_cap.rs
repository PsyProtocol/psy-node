...
use crate::{
    guta::gadgets::dual_variable_height_state_transition::DualVariableHeightStateTransitionGadget, proof_minifier::pm_core::get_circuit_fingerprint_generic, qstandard::{QPsyNetworkCircuitWithType, QStandardCircuit, QStandardCircuitProvableWithProofStoreAndRefLibraryAsync, QStandardCircuitProvableWithRawProofsAndRefLibrary, proof_store::QProofStoreReaderAsync}, utils::proof_library::get_two_child_proofs_for_api_response_with_inclusion_proof
};
...
where
    ...
    pub fn prove_base(
        ...
        self.dvh_state_transition_gadget.set_witness_partial(
            &mut pw,
            &input.nca_proof
        )?;
