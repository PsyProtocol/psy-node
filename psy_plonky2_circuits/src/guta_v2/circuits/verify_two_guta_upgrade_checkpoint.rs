...
use crate::{
    guta::gadgets::{helpers::ToGUTAHeader, dual_variable_height_state_transition::DualVariableHeightStateTransitionGadget, verify_guta_proof::VerifyGUTAProofGadget},
...
#[derive(Debug)]
pub struct GUTAVerifyTwoGUTAUpgradeCheckpointCircuitV2<C: GenericConfig<D> + 'static, const D: usize>
where
...
impl<C: GenericConfig<D>, const D: usize> QPsyNetworkCircuitWithType for GUTAVerifyTwoGUTAUpgradeCheckpointCircuitV2<C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
...
impl<C: GenericConfig<D> + 'static, const D: usize> GUTAVerifyTwoGUTAUpgradeCheckpointCircuitV2<C, D>
where
    ...
    C::F: QRichField,
{
    pub fn new(
        ...
        builder.print_gate_counts_with_message("G2GUpgrade before dvh_state_transition_gadget");
        ...
        builder.print_gate_counts_with_message("G2GUpgrade after dvh_state_transition_gadget");
...
impl<C: GenericConfig<D> + 'static, const D: usize> QStandardCircuit<C, D> for GUTAVerifyTwoGUTAUpgradeCheckpointCircuitV2<C, D>
where
    C::Hasher: AlgebraicHasher<C::F>,
{
...
impl<L: CircuitInfoLibrary<C, D>, C: GenericConfig<D>, const D: usize> QStandardCircuitProvableWithRawProofsAndRefLibrary<L, C, D>
    for GUTAVerifyTwoGUTAUpgradeCheckpointCircuitV2<C, D>
where
    C::Hasher: AlgebraicHasher<C::F> + MerkleZeroHasher<HashOut<C::F>> + MerkleZeroHasher<QHashOut<C::F>>,
