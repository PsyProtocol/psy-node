...
use crate::{
    guta::gadgets::{
        helpers::ToGUTAHeader, dual_variable_height_state_transition::DualVariableHeightStateTransitionGadget, verify_guta_proof::VerifyGUTAProofGadget
    },
...
impl<C: GenericConfig<D>, const D: usize> QPsyNetworkCircuitWithType for GUTAVerifyTwoGUTACircuitV2<C, D> where
    C::Hasher:AlgebraicHasher<C::F>,
{
