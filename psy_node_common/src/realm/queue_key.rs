...
use psy_data::{queue_items::realm_user_update::PsyRealmUserUpdateQueueItem, worker::metadata_with_job_id::PsyProvingJobMetadataWithJobId};
...
pub type RealmUserUpdateQueueKey<F, Hash> =
    QPStandardUniqueIdQueueKey<PQ_REALM_SUBMIT_USER_UPDATE_QUEUE_TOPIC_ID, PsyRealmUserUpdateQueueItem<F, Hash>>;
