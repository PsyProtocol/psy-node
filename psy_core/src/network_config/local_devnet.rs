...
impl QNetworkTreeCircuitSpecificConstants for PsyNetworkLocalDevnetConstants {
    ...
    const BATCH_DEPLOY_CONTRACT_SUB_TREE_HEIGHT: usize = 1;
    ...
    const END_CAP_CIRCUIT_FINGERPRINT_HASH_U64_X4: [u64; 4] = [14579702345249895927, 4891384284341734771, 14274363440915533655, 15620378163618375024];
}
