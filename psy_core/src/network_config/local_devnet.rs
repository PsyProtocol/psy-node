...
impl QNetworkTreeCircuitSpecificConstants for PsyNetworkLocalDevnetConstants {
    ...
    const END_CAP_CIRCUIT_FINGERPRINT_HASH_U64_X4: [u64; 4] = [12774889947057604102, 17980055523819421257, 16617768518076201287, 9496811998572474265];
}
