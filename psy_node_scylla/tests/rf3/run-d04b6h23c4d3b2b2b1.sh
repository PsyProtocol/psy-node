...
export PSY_D04B6H23C4D3B1_RF3=1
export PSY_D04B6H23C4D3B2B2B1_RF3=1
export PSY_D04B6H23C4C2B4E3_REPORT_OVERRIDE="${WORKSPACE_DIR}/target/d04b6h23c4d3b2b2b1-coordinator-handler-recovery-prefix-rf3-report.json"
