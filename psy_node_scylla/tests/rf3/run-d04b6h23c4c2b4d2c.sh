...
REPORT_PATH="${WORKSPACE_DIR}/target/d04b6h23c4c2b4d2c-rotation-route-rf3-report.json"
NATS_DIR="$(mktemp -d /tmp/psy-h23d2c-nats.XXXXXX)"
...
nats-server --server_name psy-h23d2c-n1 --cluster_name psy-h23d2c \
...
NATS1_PID=$!
nats-server --server_name psy-h23d2c-n2 --cluster_name psy-h23d2c \
...
NATS2_PID=$!
nats-server --server_name psy-h23d2c-n3 --cluster_name psy-h23d2c \
...
cd "${WORKSPACE_DIR}"
PSY_D04B6H23C4C2B4D2C_RF3=1 \
PSY_D04B6H23C4C2B4D2C_COMPOSE_FILE="${COMPOSE_FILE}" \
PSY_D04B6H23C4C2B4D2C_REPORT_PATH="${REPORT_PATH}" \
PSY_D04B6H23C4C2B4D2C_NATS_URLS="nats://127.0.0.1:45322,nats://127.0.0.1:45323,nats://127.0.0.1:45324" \
PSY_D04B6H23C4C2B4D2C_NATS1_PID="${NATS1_PID}" \
PSY_D04B6H23C4C2B4D2C_NATS2_PID="${NATS2_PID}" \
PSY_D04B6H23C4C2B4D2C_NATS3_PID="${NATS3_PID}" \
cargo test -p psy_node_scylla \
  rollback::pending_queue_stream_provision_rf3::d04b6h23c4c2b4d2c_rotation_route_joint_rf3 \
  --lib -- --ignored --exact --nocapture

echo "D-04b6h23c4c2b4d2c rotation/route RF=3 report: ${REPORT_PATH}"
