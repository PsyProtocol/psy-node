...
REPORT_PATH="${WORKSPACE_DIR}/target/d04b6h23c4c2b4d2-stream-provision-rf3-report.json"
NATS_DIR="$(mktemp -d /tmp/psy-h23d2-nats.XXXXXX)"
...
nats-server --server_name psy-h23d2-n1 --cluster_name psy-h23d2 \
...
NATS1_PID=$!
nats-server --server_name psy-h23d2-n2 --cluster_name psy-h23d2 \
...
NATS2_PID=$!
nats-server --server_name psy-h23d2-n3 --cluster_name psy-h23d2 \
...
cd "${WORKSPACE_DIR}"
PSY_D04B6H23C4C2B4D2_RF3=1 \
PSY_D04B6H23C4C2B4D2_COMPOSE_FILE="${COMPOSE_FILE}" \
PSY_D04B6H23C4C2B4D2_REPORT_PATH="${REPORT_PATH}" \
PSY_D04B6H23C4C2B4D2_NATS_URLS="nats://127.0.0.1:45222,nats://127.0.0.1:45223,nats://127.0.0.1:45224" \
PSY_D04B6H23C4C2B4D2_NATS1_PID="${NATS1_PID}" \
PSY_D04B6H23C4C2B4D2_NATS2_PID="${NATS2_PID}" \
PSY_D04B6H23C4C2B4D2_NATS3_PID="${NATS3_PID}" \
cargo test -p psy_node_scylla \
  rollback::pending_queue_stream_provision_rf3::d04b6h23c4c2b4d2_stream_provision_joint_rf3 \
  --lib -- --ignored --exact --nocapture

echo "D-04b6h23c4c2b4d2 stream provision RF=3 report: ${REPORT_PATH}"
