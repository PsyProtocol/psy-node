...
use parth_core::{
    crypto::hash::{tag_tree::{hash_tag_tree_node, TagTreeMerkleProof, TagTreeNodePreimage, TagTreeNodeStorage, TagTreeProofNode}, traits::MerkleHasher},
    data::{
...
impl ScyllaTagTreeNodesPreparedStatements {
    ...
    pub async fn set_tag_only_computed<Hash: QHashBase, Hasher: MerkleHasher<Hash>>(
        ...
        let left_value = left_value?.unwrap_or_default();
        let right_value = right_value?.unwrap_or_default();
