...
pub const RAW_SCYLLA_ACCESS_ALLOWLIST: &[RawScyllaAccessAllowance] = &[
    ...
    allow!("psy_node_scylla/src/rollback/branch_exact_schema_operator.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/src/rollback/coordinator_processor_full_commit.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/coordinator_commit_delete_restore_executor.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/src/rollback/coordinator_commit_full_completion_store.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/coordinator_commit_full_manifest_store.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/src/rollback/coordinator_rollback_global_progress.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/coordinator_rollback_runtime_publication.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/src/rollback/realm_rollback_delete_completion.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/src/rollback/realm_rollback_delete_restore_executor.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/realm_rollback_runtime_control.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/src/rollback/rollback_abort_convergence_store.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/rollback_global_archive_barrier.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/rollback_global_delete_barrier.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/rollback_global_restore_barrier.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/rollback_joint_production_control_scylla.rs", TestHarness),
    allow!("psy_node_scylla/src/rollback/rollback_participant_plan_store.rs", DurableControlAuthority),
    allow!("psy_node_scylla/src/rollback/rollback_runtime_rebuild_store.rs", DurableControlAuthority),
    ...
    allow!("psy_node_scylla/tests/rf3/d1a08_coordinator_archive.rs", TestHarness),
