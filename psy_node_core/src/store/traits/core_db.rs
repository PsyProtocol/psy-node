...
pub trait CoreDatabaseReader<Hash: QHashBase + Send + Sync, Hasher: MerkleZeroHasher<Hash> + Send + Sync, BiDirectionalMappingTableIdentifier: Clone + Send + Sync, BiDirectionalU64MappingTableIdentifier: Clone + Send + Sync, U64CounterTableIdentifier: Clone + Send + Sync, SingleIdTableIdentifier: Clone + Send + Sync, DoubleIdTableIdentifier: Clone + Send + Sync, KivTableIdentifier: Clone + Send + Sync, SingleIdMerkleTableIdentifier: Clone + Send + Sync, DoubleIdMerkleTableIdentifier: Clone + Send + Sync>: CoreDatabaseBidirectionalMappingReader<BiDirectionalMappingTableIdentifier> + CoreDatabaseBidirectionalU64MappingReader<BiDirectionalU64MappingTableIdentifier>+ CoreDatabaseU64CounterReader<U64CounterTableIdentifier> + CoreDatabaseSingleIdCheckpointedReader<SingleIdTableIdentifier> + CoreDatabaseDoubleIdCheckpointedReader<DoubleIdTableIdentifier> + CoreDatabaseKivReader<KivTableIdentifier> + CoreDatabaseSingleIdMerkleReader<Hash, Hasher, SingleIdMerkleTableIdentifier> + CoreDatabaseDoubleIdMerkleReader<Hash, Hasher, DoubleIdMerkleTableIdentifier> {

}
impl<Hash: QHashBase + Send + Sync, Hasher: MerkleZeroHasher<Hash> + Send + Sync, BiDirectionalMappingTableIdentifier: Clone + Send + Sync, BiDirectionalU64MappingTableIdentifier: Clone + Send + Sync, U64CounterTableIdentifier: Clone + Send + Sync, SingleIdTableIdentifier: Clone + Send + Sync, DoubleIdTableIdentifier: Clone + Send + Sync, KivTableIdentifier: Clone + Send + Sync, SingleIdMerkleTableIdentifier: Clone + Send + Sync, DoubleIdMerkleTableIdentifier: Clone + Send + Sync, T: CoreDatabaseBidirectionalMappingReader<BiDirectionalMappingTableIdentifier> + CoreDatabaseBidirectionalU64MappingReader<BiDirectionalU64MappingTableIdentifier> + CoreDatabaseU64CounterReader<U64CounterTableIdentifier> + CoreDatabaseSingleIdCheckpointedReader<SingleIdTableIdentifier> + CoreDatabaseDoubleIdCheckpointedReader<DoubleIdTableIdentifier> + CoreDatabaseKivReader<KivTableIdentifier> + CoreDatabaseSingleIdMerkleReader<Hash, Hasher, SingleIdMerkleTableIdentifier> + CoreDatabaseDoubleIdMerkleReader<Hash, Hasher, DoubleIdMerkleTableIdentifier>> CoreDatabaseReader<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier> for T {
}

pub trait CoreDatabaseWriter<Hash: QHashBase + Send + Sync, Hasher: MerkleZeroHasher<Hash> + Send + Sync, BiDirectionalMappingTableIdentifier: Clone + Send + Sync, BiDirectionalU64MappingTableIdentifier: Clone + Send + Sync, U64CounterTableIdentifier: Clone + Send + Sync, SingleIdTableIdentifier: Clone + Send + Sync, DoubleIdTableIdentifier: Clone + Send + Sync, KivTableIdentifier: Clone + Send + Sync, SingleIdMerkleTableIdentifier: Clone + Send + Sync, DoubleIdMerkleTableIdentifier: Clone + Send + Sync>: CoreDatabaseBidirectionalMappingWriter<BiDirectionalMappingTableIdentifier> + CoreDatabaseBidirectionalU64MappingWriter<BiDirectionalU64MappingTableIdentifier> +  CoreDatabaseU64CounterWriter<U64CounterTableIdentifier> + CoreDatabaseSingleIdCheckpointedWriter<SingleIdTableIdentifier> + CoreDatabaseDoubleIdCheckpointedWriter<DoubleIdTableIdentifier> + CoreDatabaseKivWriter<KivTableIdentifier> + CoreDatabaseSingleIdMerkleWriter<Hash, Hasher, SingleIdMerkleTableIdentifier> + CoreDatabaseDoubleIdMerkleWriter<Hash, Hasher, DoubleIdMerkleTableIdentifier> {

}
impl<Hash: QHashBase + Send + Sync, Hasher: MerkleZeroHasher<Hash> + Send + Sync, BiDirectionalMappingTableIdentifier: Clone + Send + Sync, BiDirectionalU64MappingTableIdentifier: Clone + Send + Sync, U64CounterTableIdentifier: Clone + Send + Sync, SingleIdTableIdentifier: Clone + Send + Sync, DoubleIdTableIdentifier: Clone + Send + Sync, KivTableIdentifier: Clone + Send + Sync, SingleIdMerkleTableIdentifier: Clone + Send + Sync, DoubleIdMerkleTableIdentifier: Clone + Send + Sync, T: CoreDatabaseBidirectionalMappingWriter<BiDirectionalMappingTableIdentifier> + CoreDatabaseBidirectionalU64MappingWriter<BiDirectionalU64MappingTableIdentifier> + CoreDatabaseU64CounterWriter<U64CounterTableIdentifier> + CoreDatabaseSingleIdCheckpointedWriter<SingleIdTableIdentifier> + CoreDatabaseDoubleIdCheckpointedWriter<DoubleIdTableIdentifier> + CoreDatabaseKivWriter<KivTableIdentifier> + CoreDatabaseSingleIdMerkleWriter<Hash, Hasher, SingleIdMerkleTableIdentifier> + CoreDatabaseDoubleIdMerkleWriter<Hash, Hasher, DoubleIdMerkleTableIdentifier>> CoreDatabaseWriter<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier> for T {
}
pub trait CoreDatabaseStore<Hash: QHashBase + Send + Sync, Hasher: MerkleZeroHasher<Hash> + Send + Sync, BiDirectionalMappingTableIdentifier: Clone + Send + Sync, BiDirectionalU64MappingTableIdentifier: Clone + Send + Sync, U64CounterTableIdentifier: Clone + Send + Sync, SingleIdTableIdentifier: Clone + Send + Sync, DoubleIdTableIdentifier: Clone + Send + Sync, KivTableIdentifier: Clone + Send + Sync, SingleIdMerkleTableIdentifier: Clone + Send + Sync, DoubleIdMerkleTableIdentifier: Clone + Send + Sync>: CoreDatabaseReader<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier> + CoreDatabaseWriter<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier> {

}
impl<Hash: QHashBase + Send + Sync, Hasher: MerkleZeroHasher<Hash> + Send + Sync, BiDirectionalMappingTableIdentifier: Clone + Send + Sync, BiDirectionalU64MappingTableIdentifier: Clone + Send + Sync, U64CounterTableIdentifier: Clone + Send + Sync, SingleIdTableIdentifier: Clone + Send + Sync, DoubleIdTableIdentifier: Clone + Send + Sync, KivTableIdentifier: Clone + Send + Sync, SingleIdMerkleTableIdentifier: Clone + Send + Sync, DoubleIdMerkleTableIdentifier: Clone + Send + Sync, T: CoreDatabaseReader<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier> + CoreDatabaseWriter<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier>> CoreDatabaseStore<Hash, Hasher, BiDirectionalMappingTableIdentifier, BiDirectionalU64MappingTableIdentifier, U64CounterTableIdentifier, SingleIdTableIdentifier, DoubleIdTableIdentifier, KivTableIdentifier, SingleIdMerkleTableIdentifier, DoubleIdMerkleTableIdentifier> for T {
}
