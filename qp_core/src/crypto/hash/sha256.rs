...
use crate::common::{data::core::hash::hash256::Hash256, traits::merkle::{iterate_merkle_hasher, BasicBytesHasher, BasicDataHasher, MerkleHasher, MerkleZeroHasher, ZeroableHash}};
...
impl MerkleZeroHasher<Hash256> for CoreSha256Hasher {
    fn get_zero_hash(reverse_level: usize) -> Hash256 {
        iterate_merkle_hasher::<Hash256, Self>(Hash256::get_zero_value(), reverse_level)
    }
}
