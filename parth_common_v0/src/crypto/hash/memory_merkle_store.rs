...
use crate::{crypto::hash::{merkle_proof::{DeltaMerkleProofCore, MerkleProofCore}, spiderman::SpidermanUpdateProof, traits::MerkleZeroHasher}, data::hash::merkle_node_key::SimpleMerkleNodeKey, utils::math::ceil_div_usize};
...
mod tests {
    ...
    use crate::{crypto::hash::sha256::CoreSha256Hasher, data::hash::{hash256::Hash256, merkle_node_key::SimpleMerkleNodeKey}};
    ...
    fn test_rehash_tree() {
        ...
        let mut tree_a = SimpleMerkleTree::<H, Hash256>::new(12);
        let mut tree_b = SimpleMerkleTree::<H, Hash256>::new(12);
    ...
    fn test_append_spiderman_simple(top_line_height: usize, web_tree_height: usize, append_leaf_ct: usize, start_index: usize) {
        ...
        let mut tree = SimpleMerkleTree::<CoreSha256Hasher, Hash256>::new(total_height as u8);
