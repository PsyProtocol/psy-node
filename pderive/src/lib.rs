...
#[proc_macro_attribute]
pub fn serialize_clone_f_ts(_attr: TokenStream, input: TokenStream) -> TokenStream {
    let mut item_struct = parse_macro_input!(input as ItemStruct);
...
#[proc_macro_attribute]
pub fn serialize_copy_default_no_ord_ts(_attr: TokenStream, input: TokenStream) -> TokenStream {
    let mut item_struct = parse_macro_input!(input as ItemStruct);
