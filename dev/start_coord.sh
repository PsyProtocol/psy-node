...
./target/release/psy_worker_cli worker --user 0 --network local-devnet --config ./psy_cli/example_node_configs/worker_coordinator.yml > logs/worker_coordinator_logs.txt 2>&1 &
