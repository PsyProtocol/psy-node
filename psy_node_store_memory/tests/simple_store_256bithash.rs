...
impl SimpleStoreEx {
    pub async fn setup(store: Arc<InMemoryTestStore>) -> anyhow::Result<Self> {
        let simple_store = QSimpleStore::new(
            store,
            Arc::new(InMemoryTableIdentifier::KivTableA),
            Arc::new(InMemoryTableIdentifier::KivTableB),
            Arc::new(InMemoryTableIdentifier::BidirectionalMappingTableA),
            Arc::new(InMemoryTableIdentifier::BidirectionalMappingTableB),
            Arc::new(InMemoryTableIdentifier::ObjSingleIdTableA),
            Arc::new(InMemoryTableIdentifier::ObjSingleIdTableB),
            Arc::new(InMemoryTableIdentifier::ObjDoubleIdTableA),
            Arc::new(InMemoryTableIdentifier::ObjDoubleIdTableB),
            Arc::new(InMemoryTableIdentifier::U64TableA),
            Arc::new(InMemoryTableIdentifier::U64TableB),
            Arc::new(InMemoryTableIdentifier::U64U128BiDirectionalMappingTableA),
            Arc::new(InMemoryTableIdentifier::U64U128BiDirectionalMappingTableB),
            Arc::new(InMemoryTableIdentifier::MerkleNodeZeroIdTableA),
            Arc::new(InMemoryTableIdentifier::MerkleNodeZeroIdTableB),
            Arc::new(InMemoryTableIdentifier::MerkleNodeSingleIdTableA),
            Arc::new(InMemoryTableIdentifier::MerkleNodeSingleIdTableB),
            Arc::new(InMemoryTableIdentifier::MerkleNodeDoubleIdTableA),
            Arc::new(InMemoryTableIdentifier::MerkleNodeDoubleIdTableB),
            Arc::new(InMemoryTableIdentifier::TagTreeTableA),
            Arc::new(InMemoryTableIdentifier::TagTreeTableB),
        );
