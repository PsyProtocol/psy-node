...
local_cf_default_release_id() {
  ...
  deployment_file="$PARTH_DIR/psy-dapp/psy-contracts/deployments/localhost/deployed-contracts.json"
...
LOCAL_CF_WALLET_R2_RELEASE_PREFIX="${LOCAL_CF_WALLET_R2_RELEASE_PREFIX:-local-devnet/releases/$LOCAL_CF_FRONTEND_RELEASE_ID}"
