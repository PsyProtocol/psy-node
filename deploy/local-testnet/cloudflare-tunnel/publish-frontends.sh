...
LOCAL_CF_LOCALHOST_DEPLOYMENT_FILE="${LOCAL_CF_LOCALHOST_DEPLOYMENT_FILE:-$PARTH_DIR/psy-dapp/psy-contracts/deployments/localhost/deployed-contracts.json}"
LOCAL_CF_BACKEND_DEPLOYMENT_FILE="${LOCAL_CF_BACKEND_DEPLOYMENT_FILE:-$PARTH_DIR/psy-contracts/deployments/localhost/deployed-contracts.json}"
...
if [ -s "$LOCAL_CF_BACKEND_DEPLOYMENT_FILE" ]; then
  cp "$LOCAL_CF_BACKEND_DEPLOYMENT_FILE" "$LOCAL_CF_LOCALHOST_DEPLOYMENT_FILE"
fi
