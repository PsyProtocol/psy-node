...
elif [ "$L1_DEPLOYMENTS_NETWORK" = "bsc-testnet" ] || [ "$L1_DEPLOYMENTS_NETWORK" = "bscTestnet" ]; then
  network_env_key="BSC_TESTNET_RPC_URL"
elif [ "$L1_DEPLOYMENTS_NETWORK" = "base-sepolia" ] || [ "$L1_DEPLOYMENTS_NETWORK" = "baseSepolia" ]; then
