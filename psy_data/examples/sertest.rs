...
impl FromU64x4 for ZHashOut<ExampleFelt> {
    #[inline(always)]
    fn from_u64x4(value: [u64; 4]) -> Self {
        bytemuck::cast(value)
    }
}

impl FromU64x4 for ZHashOut<PF> {
    #[inline(always)]
    fn from_u64x4(value: [u64; 4]) -> Self {
        bytemuck::cast(value)
    }
...
fn main() {
    ...
    for _ in 0..TOTAL_ITERATIONS {
        ...
        ser = test_a(p);
        p = test_a_back(ser);
        p.balance = ZFelt::from_owned_u64(ctr);
    }
    println!("Ctr: {}", ctr);
    ...
    let de = ExampleUser::<_, _>::from_serialize_bytes(ser);
