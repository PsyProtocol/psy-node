...
use parth_core::{crypto::hash::traits::MerkleZeroHasher, data::{db::{row::{QDatabaseDoubleIdTableRow, QDatabaseDoubleIdTableRowNoCheckpointId, QDatabaseKeyIdValueTableRow, QDatabaseSingleIdTableRow, QDoubleIdKey}, table::QDatabaseTableRoutingKey}, hash::hash256::Hash256, serializable::{QPDPair, QPDPairWithCheckpointId}}, protocol::core_types::QHashBase};
...
impl ExDepositInfo {
    pub fn new(from_chain: u32, amount: u64, recipient_user_id: u64, deposit_counter: u64) -> Self {
        Self {
            from_chain,
            amount,
            recipient_user_id,
...
impl ExContractFunctionInfo {
    pub fn new(verifier_data_hash: Hash256) -> Self {
        Self {
            verifier_data_hash,
        }
...
pub fn bench_obj_operations(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("object_ops_large_2");
