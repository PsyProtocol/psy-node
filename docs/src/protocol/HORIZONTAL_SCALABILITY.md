# Psy Horizontal Scalability Through PARTH and Zero-Knowledge Proofs
...
- [1. The Serial Bottleneck](#1-the-serial-bottleneck)
- [2. PARTH: Foundation for Parallelism](#2-parth-foundation-for-parallelism)
- [3. End-to-End Zero-Knowledge Proof Process](#3-end-to-end-zero-knowledge-proof-process)
- [4. Checkpoint Tree and Circuit Roles](#4-checkpoint-tree-and-circuit-roles)
...
## 2. PARTH: Foundation for Parallelism
...
## 3. End-to-End Zero-Knowledge Proof Process
...
*   Once verified, the new `CHKP` root becomes the finalized state snapshot for that block.

## 4. Checkpoint Tree and Circuit Roles
