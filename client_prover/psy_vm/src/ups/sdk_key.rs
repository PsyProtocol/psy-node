...
use psy_client_data::dpn::sdk_key::{SDKKeySecp256k1WitnessSlot, SDKKeyTransactionInfo};
...
/// Complete input for an SDK key circuit prover.
///
...
pub struct SDKKeyCircuitWitnessInput {
    ...
    pub transaction_infos: Vec<SDKKeyTransactionInfo<GF>>,
    ...
    pub secp256k1_slots: Vec<SDKKeySecp256k1WitnessSlot<GF>>,
...
/// The output of proving an SDK key circuit.
///
