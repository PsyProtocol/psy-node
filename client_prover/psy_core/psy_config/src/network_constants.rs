pub use crate::{
    COORDINATOR_RPC_URL, COORDINATOR_USER_TREE_HEIGHT, CURRENT_NETWORK, DEPLOY_CONTRACT_FEE, DEPOSIT_TREE_CONTRACT_STATE_TREE_HEIGHT,
    FAUCET_CONTRACT_STATE_TREE_HEIGHT, GLOBAL_USER_TREE_HEIGHT, GROUP_REALM_HEIGHT, GUTA_FEE, MINING_REWARDS_CONTRACT_STATE_TREE_HEIGHT,
    ...
    TOKEN_CONTRACT_STATE_TREE_HEIGHT, USDT_TOKEN_CONTRACT_STATE_TREE_HEIGHT, WITHDRAWAL_TREE_CONTRACT_STATE_TREE_HEIGHT,
};
...
pub const MAX_EVENT_RECORDS_PER_CALL: usize = 32;
